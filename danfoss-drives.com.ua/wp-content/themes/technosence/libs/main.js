$(function() {
  ...
  responsive: [
    ...
    const validation = new JustValidate('#why__form');
...
validation
  .addField('#form__input-name', [
    {
      rule: 'minLength',
      value: 2,
      errorMessage: 'Дуже коротке ім\'я'
    },
    {
      rule: 'maxLength',
      value: 30,
      errorMessage: 'Дуже довге ім\'я'
    },
    {
        rule: 'required',
  ...
  .addField('#form__input-surname', [
    {
      rule: 'minLength',
      value: 2,
      errorMessage: 'Дуже коротке прізвище'
    },
    {
      rule: 'maxLength',
      value: 40,
      errorMessage: 'Дуже довге прізвище'
    },
    {
        rule: 'required',
        errorMessage: 'Це поле обов\'язкове'
  ...
  .addField('#form__input-email', [
    ...
    {
      rule: 'email',
      errorMessage: 'Введіть пошту коректно',
    },
  ])
  .addField('#form__input-tel', [
    ...
    // let validateForms = function(selector,rules,modal,yaGoal){
    ...
    //     })
    // }
    // validateForms('.why__form', 
    // {email: {required: true, email:true}},
    // {name: {required: true, minLenght:2, maxLenght:15}},
    // {tel:{required: true}},
    // {surname:{required: true, minLenght:2, maxLenght:40}},'.thanks-popup','send goal');
});


function valid(){

    let name = document.getElementById('form__input-name');
    let surname = document.getElementById('form__input-surname');
    let email = document.getElementById('form__input-email');
    let tel = document.getElementById('form__input-tel');
    surname.style.border = "bottom 1px solid grey;";
    email.style.border = "bottom 1px solid grey;";
    tel.style.border = "bottom 1px solid grey;";
    console.log(name);
    ...
    if(!name.value){
        ...
        name.style.border = "bottom 1px solid grey;";
